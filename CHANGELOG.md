## [2026-07-29 13:32:00]
1. 【使用情况】所有成��显示从美元换为人民币（汇率 ×7.3）

## [2026-07-29 11:00:00]
1. 【使用情况】顶部卡片���加 Cache Hit Rate 缓存命中率展示
2. 【Dashboard】noAuth 供应商��关控制（settings API）
3. 【Dashboard】限流通知增加"确认"关闭按钮
4. 【Dashboard】用量统计过滤已禁用免费���应商
5. 【Script】���加 restart.sh 本地重启脚本
