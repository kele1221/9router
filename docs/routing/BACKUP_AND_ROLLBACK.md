...
3. 完整备份 `~/.9router`、LaunchAgent 和当前运行命令。
...
对比 Provider Connections、Provider Nodes、API Keys、Combos、KV、Usage 和 Request Details 数量，并验证 Claude-CN → Model-Switch → 9Router → 供应商链路。
