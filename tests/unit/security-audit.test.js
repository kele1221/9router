...
// Source reads below are repo-relative; vitest may run from tests/ or the repo root.
const REPO_ROOT = path.resolve(import.meta.dirname, "../..");
const readRepoFile = (relPath) => fs.readFileSync(path.join(REPO_ROOT, relPath), "utf-8");
...
describe("AUDIT-002: API key masking", () => {
  it("source should contain maskApiKey function", () => {
    const source = readRepoFile("src/lib/db/repos/usageRepo.js");
...
describe("AUDIT-003: Proxy URL validation", () => {
  ...
  it("source should contain validateProxyUrl function", () => {
    const source = readRepoFile("src/lib/network/outboundProxy.js");
...
describe("AUDIT-018: XSS escaping in OAuth callback", () => {
  it("source should contain escapeHtml function", () => {
    const source = readRepoFile("src/lib/oauth/utils/server.js");
...
describe("AUDIT-004: Atomic lock file for MITM startup", () => {
  it("manager.js should define LOCK_FILE constant", () => {
    const source = readRepoFile("src/mitm/manager.js");
